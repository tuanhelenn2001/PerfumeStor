...
<!--Content Start Here -->
<h3 style="text-align: center">DANH SÁCH THỐNG KÊ </h3>
<a href="them_pttt.php?idPTTT=<?php echo $r['idPTTT'];?>" ><strong><button type="button" class="btn btn-info"> THÊM </button></strong></a>
<div>
